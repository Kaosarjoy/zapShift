        ...
        axiosSecure.post("/parcels", data).then((res) => {
          ...
          if (res.data.insertedId) {
            ...
            Swal.fire({
              position: "top-center",
              icon: "success",
              title: "Your Parcel Create.Please Pay First",
        ...
        <form onSubmit={handleSubmit(handleSendParcel)} className="space-y-6">
          ...
          <div className="flex gap-8 mb-6">
            <label className="flex items-center gap-2 cursor-pointer">
              ...
              />
              <span className="text-sm font-medium text-[#003d3d]">
                Document
              </span>
            </label>
            <label className="flex items-center gap-2 cursor-pointer">
          ...
          {errors.parcelType && (
            <p className="text-red-500 text-sm">Please select parcel type.</p>
          )}

          {/* Parcel Basics */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-1">
              <label className="text-xs font-bold text-[#003d3d]">
                Parcel Name
              </label>
              <input
                type="text"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            {/* Receiver Details */}
            <div className="space-y-4">
              <h2 className="font-bold text-[#003d3d] mb-2">
                Receiver Details
              </h2>
              <div className="space-y-1">
                <label className="text-xs font-semibold text-gray-600">
              ...
              <div className="space-y-1">
                ...
                {errors.receiverPhoneNo && (
                  <p className="text-red-500 text-sm">
                    {errors.receiverPhoneNo.message}
                  </p>
                )}
              </div>
              {/* reciver Region*/}
